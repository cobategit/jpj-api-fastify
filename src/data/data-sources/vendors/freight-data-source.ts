...
export class FreightDataSource implements IFreighDataSource {
    ...
    async insert(data?: FreightEntity): Promise<any> {
        const res = await this.dml.dataManipulation(
            ...
            `insert into ${process.env.TABLE_VENDOR} (freight_code, freight_supplier, freight_address, active, id_user_stockpile, file_npwp, file_pkp, file_rek_bank, file_ktp) VALUES (?,?,?,?,?,?,?,?,?)`,
