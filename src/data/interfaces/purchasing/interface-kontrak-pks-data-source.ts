...
export interface IPurchasingDataSource {
    ...
    selectAll(conf: Pick<ParamsEntity, 'limit' | 'offset' | 'search' | 'kontrak_type' | 'pks_type' | 'stockpile_id' | 'final_status' | 'user_id'>): Promise<PurchasingEntity[]>
...
export interface IPurchasingDetailDataSource {
    ...
    selectOne(id?: number): Promise<PurchasingDetailEntity | null>
