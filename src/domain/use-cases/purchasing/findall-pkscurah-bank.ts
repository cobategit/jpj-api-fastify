...
import { IGetAllPksCurahBankUseCase, IPurchasingRepo } from "../../interfaces";

export class GetAllPksCurahBankUseCase implements IGetAllPksCurahBankUseCase {
    ...
    async execute(conf?: ParamsEntity | undefined): Promise<Record<string, any>> {
        try {
            ...
            const res = await this.purchasingRepo.findAllPksCurahBank(conf)
